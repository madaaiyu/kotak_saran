    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 text-center">
          <h2 class="section-heading text-uppercase h5">Registrasi</h2>
          <h3 class="section-subheading text-muted h5">Peserta didik</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <label class="form-label">Sekolah</label>
                 <input type="text" name="sekolah" class="form-control" aria-describedby="emailHelp">
                  <p class="help-block text-danger"></p>
                </div>
                <div class="form-group">
                <label class="form-label">Kelas</label>
                 <input type="text" name="kelas" class="form-control" aria-describedby="emailHelp">
                  <p class="help-block text-danger"></p>
                </div>
              </div>
              <div class="col-md-6">
...
if(isset($_POST['submit'])){
    ...
    $control = new control();
    $create = $control->register($id,$nama,$alamat,$sekolah,$kelas);
    if($create){
